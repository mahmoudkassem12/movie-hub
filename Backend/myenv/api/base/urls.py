...
urlpatterns = [
    ...
    path('admin/movies/create/', AdminMovieListCreate.as_view(),
    ...
    path('posts/create/<int:user_id>',
         PostCreateView.as_view(), name='post_create'),
    path('posts/<int:pk>/update/', PostUpdateView.as_view(), name='post-update'),
    # path('posts/<int:pk>/delete/', PostDeleteView.as_view(), name='post-delete'),

    # Comments
    path('posts/<int:post>/comments/',
         CommentdetailView.as_view(), name='post_comments'),
    path('users/<int:userid>/posts/<int:postid>/delete/',
         PostDeleteView.as_view(), name="post_delete"),
    path('comments/', CommentListView.as_view(), name='comment-list'),
    path('users/<int:userid>/posts/<int:postid>/comments/create/',
         UserCommentCreateView.as_view(), name='user_comment_create'),
